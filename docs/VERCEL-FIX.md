...
| `GEMINI_MODEL` | `gemini-2.5-pro` (optional; flash = по-бърз) |
...
### 3. Node.js version и Framework

In Vercel → **Settings** → **General**:
- **Node.js Version** → **20.x**
- **Framework Preset** → **Other** (не „Node.js Server“ — API е в `api/`, статиката в `public/`)
