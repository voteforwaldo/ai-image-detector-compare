...
export function reconcileGeminiWithSynthid(gemini, synthid) {
  ...
  const aiPercent = verdict === "ai" ? gemini.aiPercent : verdict === "human" ? gemini.aiPercent : 50;
  const humanPercent = verdict === "human" ? gemini.humanPercent : verdict === "ai" ? gemini.humanPercent : 50;
