...
7. **Задължително** прегледай цялата снимка за водни знаци — видими (лого, текст, overlay) и digital (badges, provenance UI, platform marks). Това е отделна стъпка преди verdict.
...
### B. Digital watermarks — какво да търсиш визуално в снимката
Digital watermarks не винаги се виждат, но прегледай изображението за:
- **Content Credentials / C2PA badges** — икони, етикети, info panels в screenshot или overlay („Content Credentials“, „Cr:AI“, synthetic label)
- **Platform provenance UI** — „Created with Google AI“, Imagen/Gemini export frames, OpenAI verify badges
- **SynthID** (Google): imperceptible в пикселите — **не твърди „открит SynthID“** само от картинка; но при явен Google AI UI → спомени „вероятен SynthID“
- **Digimarc-style** или faint repeating patterns в uniform areas (sky, wall) — само ако реално ги виждаш
- **Embedded generator marks** — малки signature marks, corner stamps, semi-transparent repeated text
→ Видим digital/provenance mark или badge: verdict MUST be "ai", confidence ≥ 88.
→ Липса на видими digital marks **не доказва** „human“.
...
| verdict | Кога |
|---------|------|
| ai | ≥1 твърд сигнал (видим watermark, digital provenance badge, лого/UI, Google AI контекст) ИЛИ ≥3 AI индикатора от D–G |
...
- 92–100: видим watermark/лого/UI, digital provenance badge, или Google AI screenshot
